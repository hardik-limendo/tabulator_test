...
app_description = "Tabulator Report View"
app_email = "info@limendo.com"
app_license = "MIT"
...
app_include_css = [
    "/assets/tabulator/css/tabulator.min.css"
    # "/assets/tabulator/css/tabulator_bootstrap5.min.css"
    # "/assets/tabulator/css/tabulator_materialize.min.css"
                   ]
app_include_js = ["/assets/tabulator/js/tabulator.min.js"]

# include js, css files in header of web template
# web_include_css = "/assets/tabulator/css/tabulator.min.css"
# web_include_js = "/assets/tabulator/js/tabulator_esm.min.js"
...
# Request Events
# ----------------
# before_request = ["tabulator.utils.before_request"]
# after_request = ["tabulator.utils.after_request"]

# Job Events
# ----------
# before_job = ["tabulator.utils.before_job"]
# after_job = ["tabulator.utils.after_job"]
